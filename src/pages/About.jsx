...
const About = () => {
  ...
  return (
    <section className="max-w-4xl mx-auto px-6 py-16 animate-fade-in">
      ...
      <p className="text-lg mb-6 text-gray-700 text-center">{translations.about.paragraph}</p>
      ...
      <div className="grid md:grid-cols-2 gap-8 mt-10">
        <div className="bg-white p-6 rounded-lg shadow border">
          ...
          <ul className="list-disc list-inside text-gray-600">
            {translations.about.stackItems.map((item, i) => (
              <li key={i}>{item}</li>
            ))}
          </ul>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow border">
          ...
          <p className="text-gray-600">{translations.about.experienceText}</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow border">
          ...
          <ul className="list-disc list-inside text-gray-600">
            {translations.about.skillItems.map((item, i) => (
              <li key={i}>{item}</li>
            ))}
          </ul>
        </div>
